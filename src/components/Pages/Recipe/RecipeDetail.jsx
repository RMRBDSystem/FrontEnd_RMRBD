    ...
    return (
        <div className="max-w-6xl mx-auto p-6 bg-white shadow-md rounded-lg grid grid-cols-2 gap-8">
            ...
            <div>
                ...
                <p className="text-xl text-gray-600 mt-1">Nhà cung cấp: {recipe.createById}</p>
                ...
                <div className="border-t border-gray-200 pt-6 mt-6">
                    ...
                    <ul className="text-gray-700 text-lg">
                        ...
                        <li><span className="font-semibold">Hướng dẫn (gr):</span> {recipe.Tutorial}</li>
                        <li><span className="font-semibold">Video (gr):</span> {recipe.Video}</li>
                        <li><span className="font-semibold">Giá (gr):</span> {recipe.Price}</li>
                        <li><span className="font-semibold">Thành phần (gr):</span> {recipe.Ingredient}</li>
