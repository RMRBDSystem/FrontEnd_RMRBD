...
function Sidebar({ onFilterChange }) {
  ...
  return (
    <div className="p-4 rounded-lg shadow-md">
      <h2 className="font-bold text-transparent bg-clip-text bg-gradient-to-r text-black text-lg mb-6">
        Nhóm Sản Phẩm
      </h2>

      {/* Loại Sách */}
      <div className="mb-6">
        <label className="inline-block font-bold text-transparent bg-clip-text bg-gradient-to-r text-black mb-5">
          Loại Sách
        </label>
        ...
        {/* Nút Bỏ chọn */}
        <button
          className="mt-4 px-4 py-2 text-sm font-medium text-black rounded"
      ...
      {/* Giá */}
      <div className="mb-6">
        <label className="inline-block font-bold text-transparent text-black bg-clip-text mb-5">
          Giá
        </label>
        <ul className="space-y-3">
          {[
            ...
            <li key={index} className="flex items-center">
              ...
              />
              <span className="text-black">{priceRange.label}</span>
            </li>
          ))}
        </ul>
      </div>
      ...
      {/* Đánh Giá */}
      <div className="mb-6">
        <label className="inline-block font-bold text-transparent bg-clip-text text-black bg-gradient-to-r mb-5">
          Đánh Giá
        </label>
        <ul className="space-y-3">
          {[5, 4, 3, 2, 1].map((rating) => (
            <li key={rating} className="flex items-center">
              ...
              />
              <span className="text-black">{rating} sao</span>
            </li>
          ))}
        </ul>
      </div>
